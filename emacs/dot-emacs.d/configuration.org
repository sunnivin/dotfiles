...
#+AUTHOR: Sunniva Indrehus' personal change set of  Harry R. Schwartz's configuration, 
#+EMAIL: sunniva.indrehus@gmail.com, hello@harryrschwartz.com
...
#+begin_src emacs-lisp
  (setq user-full-name "Sunniva Indrehus"
        user-mail-address "sunniva.indrehus@gmail.com"
...
** Automatic closure of parenthesis when programming 
Use smartparens for automatically closing parenthesis in
programming mode 
#+begin_src emacs-lisp
  ;; global
...
** Ability to display emojis in commit messages
#+begin_src emacs-lisp
  (use-package emojify
...
** Bookmark for shell session  

Add bookmark to eshell session.
...
* Cyce between spacing alternatives
